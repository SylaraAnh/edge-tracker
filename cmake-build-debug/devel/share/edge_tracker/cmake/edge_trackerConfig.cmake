...
if(edge_tracker_CONFIG_INCLUDED)
  return()
endif()
set(edge_tracker_CONFIG_INCLUDED TRUE)

# set variables for source/devel/install prefixes
if("TRUE" STREQUAL "TRUE")
  set(edge_tracker_SOURCE_PREFIX /home/wjc/code/ws_edge_tracker/src/edge-tracker)
  set(edge_tracker_DEVEL_PREFIX /home/wjc/code/ws_edge_tracker/src/edge-tracker/cmake-build-debug/devel)
  set(edge_tracker_INSTALL_PREFIX "")
  set(edge_tracker_PREFIX ${edge_tracker_DEVEL_PREFIX})
else()
  set(edge_tracker_SOURCE_PREFIX "")
  set(edge_tracker_DEVEL_PREFIX "")
  set(edge_tracker_INSTALL_PREFIX /usr/local)
  set(edge_tracker_PREFIX ${edge_tracker_INSTALL_PREFIX})
endif()

# warn when using a deprecated package
if(NOT "" STREQUAL "")
  set(_msg "WARNING: package 'edge_tracker' is deprecated")
...
set(edge_tracker_FOUND_CATKIN_PROJECT TRUE)

if(NOT "/home/wjc/code/ws_edge_tracker/src/edge-tracker/cmake-build-debug/devel/include;/usr/include/pcl-1.8;/usr/include/eigen3;/usr/include;/usr/include/ni;/usr/include/openni2;/usr/include/vtk-6.3;/usr/include/freetype2;/usr/lib/x86_64-linux-gnu/openmpi/include/openmpi;/usr/lib/x86_64-linux-gnu/openmpi/include/openmpi/opal/mca/event/libevent2022/libevent;/usr/lib/x86_64-linux-gnu/openmpi/include/openmpi/opal/mca/event/libevent2022/libevent/include;/usr/lib/x86_64-linux-gnu/openmpi/include;/usr/include/python2.7;/usr/include/x86_64-linux-gnu;/usr/include/hdf5/openmpi;/usr/include/libxml2;/usr/include/jsoncpp;/usr/include/tcl " STREQUAL " ")
  set(edge_tracker_INCLUDE_DIRS "")
  set(_include_dirs "/home/wjc/code/ws_edge_tracker/src/edge-tracker/cmake-build-debug/devel/include;/usr/include/pcl-1.8;/usr/include/eigen3;/usr/include;/usr/include/ni;/usr/include/openni2;/usr/include/vtk-6.3;/usr/include/freetype2;/usr/lib/x86_64-linux-gnu/openmpi/include/openmpi;/usr/lib/x86_64-linux-gnu/openmpi/include/openmpi/opal/mca/event/libevent2022/libevent;/usr/lib/x86_64-linux-gnu/openmpi/include/openmpi/opal/mca/event/libevent2022/libevent/include;/usr/lib/x86_64-linux-gnu/openmpi/include;/usr/include/python2.7;/usr/include/x86_64-linux-gnu;/usr/include/hdf5/openmpi;/usr/include/libxml2;/usr/include/jsoncpp;/usr/include/tcl")
  if(NOT " " STREQUAL " ")
    set(_report "Check the issue tracker '' and consider creating a ticket if the problem has not been reported yet.")
  elseif(NOT " " STREQUAL " ")
    set(_report "Check the website '' for information and consider reporting the problem.")
  else()
    set(_report "Report the problem to the maintainer 'lalala <18S008062@stu.hit.edu.cn>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    if(IS_ABSOLUTE ${idir} AND IS_DIRECTORY ${idir})
      set(include ${idir})
    elseif("${idir} " STREQUAL "include ")
      get_filename_component(include "${edge_tracker_DIR}/../../../include" ABSOLUTE)
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'edge_tracker' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'edge_tracker' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/wjc/code/ws_edge_tracker/src/edge-tracker/${idir}'.  ${_report}")
    endif()
    _list_append_unique(edge_tracker_INCLUDE_DIRS ${include})
  endforeach()
endif()
...
foreach(library ${libraries})
  ...
  if("${library}" MATCHES "^(debug|optimized|general)$")
    list(APPEND edge_tracker_LIBRARIES ${library})
  elseif(${library} MATCHES "^-l")
    list(APPEND edge_tracker_LIBRARIES ${library})
  elseif(${library} MATCHES "^-")
    # This is a linker flag/option (like -pthread)
    # There's no standard variable for these, so create an interface library to hold it
    if(NOT edge_tracker_NUM_DUMMY_TARGETS)
      set(edge_tracker_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::edge_tracker::wrapped-linker-option${edge_tracker_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR edge_tracker_NUM_DUMMY_TARGETS "${edge_tracker_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::edge_tracker::wrapped-linker-option${edge_tracker_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND edge_tracker_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/wjc/code/ws_edge_tracker/src/edge-tracker/cmake-build-debug/devel/lib;/home/wjc/Downloads/ws_livox/devel/lib;/opt/ros/melodic/lib)
    ...
    endforeach()
    if(lib)
      _list_append_unique(edge_tracker_LIBRARY_DIRS ${lib_path})
      list(APPEND edge_tracker_LIBRARIES ${lib})
    else()
      # as a fall back for non-catkin libraries try to search globally
      find_library(lib ${library})
      if(NOT lib)
        message(FATAL_ERROR "Project '${PROJECT_NAME}' tried to find library '${library}'.  The library is neither a target nor built/installed properly.  Did you compile project 'edge_tracker'?  Did you find_package() it before the subdirectory containing its code is included?")
      endif()
      list(APPEND edge_tracker_LIBRARIES ${lib})
    endif()
  endif()
...
set(edge_tracker_EXPORTED_TARGETS "edge_tracker_generate_messages_cpp;edge_tracker_generate_messages_eus;edge_tracker_generate_messages_lisp;edge_tracker_generate_messages_nodejs;edge_tracker_generate_messages_py")
# create dummy targets for exported code generation targets to make life of users easier
foreach(t ${edge_tracker_EXPORTED_TARGETS})
  if(NOT TARGET ${t})
    add_custom_target(${t})
  endif()
endforeach()

set(depends "roscpp;rospy;message_runtime;std_msgs;nav_msgs;geometry_msgs;control_msgs")
foreach(depend ${depends})
  string(REPLACE " " ";" depend_list ${depend})
  # the package name of the dependency must be kept in a unique variable so that it is not overwritten in recursive calls
  list(GET depend_list 0 edge_tracker_dep)
  list(LENGTH depend_list count)
  if(${count} EQUAL 1)
    # simple dependencies must only be find_package()-ed once
    if(NOT ${edge_tracker_dep}_FOUND)
      find_package(${edge_tracker_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${edge_tracker_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  _list_append_unique(edge_tracker_INCLUDE_DIRS ${${edge_tracker_dep}_INCLUDE_DIRS})

  # merge build configuration keywords with library names to correctly deduplicate
  _pack_libraries_with_build_configuration(edge_tracker_LIBRARIES ${edge_tracker_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${edge_tracker_dep}_LIBRARIES})
  _list_append_deduplicate(edge_tracker_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(edge_tracker_LIBRARIES ${edge_tracker_LIBRARIES})

  _list_append_unique(edge_tracker_LIBRARY_DIRS ${${edge_tracker_dep}_LIBRARY_DIRS})
  list(APPEND edge_tracker_EXPORTED_TARGETS ${${edge_tracker_dep}_EXPORTED_TARGETS})
endforeach()

set(pkg_cfg_extras "edge_tracker-msg-extras.cmake")
foreach(extra ${pkg_cfg_extras})
  if(NOT IS_ABSOLUTE ${extra})
    set(extra ${edge_tracker_DIR}/${extra})
  endif()
  include(${extra})
endforeach()
